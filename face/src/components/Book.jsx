  ...
  const urlContentData = useMemo(() => {
    ...
    if (urlParams.has('title')) {
      return {
        ...
        creator: { username: urlParams.get('creator') || 'Nature Explorer' },
        content_file: urlParams.get('image_url') || null,
        image: urlParams.get('image_url') || null,
        type: urlParams.get('type') || 'video',
        share_ip: urlParams.get('share_ip'),
        share_country: urlParams.get('share_country'),
        share_region: urlParams.get('share_region'),
        shared_via: urlParams.get('shared_via')
      };
    }
    return null;
  }, []);
    ...
    setTimeout(async () => {
      try {
        ...
        const trackingData = {
          ...
          shared_by_ip: urlParams.get('share_ip'),
          shared_from_country: urlParams.get('share_country'),
          shared_from_region: urlParams.get('share_region'),
          shared_via: urlParams.get('shared_via')
        };
